        ...
        <div className="grid grid-cols-1 sm:grid-cols-12 gap-8 sm:gap-12 items-center">
          ...
          <div className="col-span-1 sm:col-span-7 sm:col-start-6">
            <div className="grid grid-cols-3 gap-4 sm:gap-8">
              <div className="text-center">
                <div className="text-[1.75rem] sm:text-[2.5rem] font-light text-[#f5f1ed] tabular-nums">76.70%</div>
                <div className="text-[0.65rem] uppercase tracking-[0.2em] text-[#b8a894] mt-2">Accuracy</div>
              </div>
              <div className="text-center">
                <div className="text-[1.75rem] sm:text-[2.5rem] font-light text-[#f5f1ed] tabular-nums">76.74%</div>
                <div className="text-[0.65rem] uppercase tracking-[0.2em] text-[#b8a894] mt-2">AUC-ROC</div>
              </div>
              <div className="text-center">
                <div className="text-[1.75rem] sm:text-[2.5rem] font-light text-[#f5f1ed] tabular-nums">75.50%</div>
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-8 mt-8">
              ...
              <div className="text-center">
                <div className="text-base sm:text-xl font-light text-[#f5f1ed] tabular-nums">68.12% ± 2.71%</div>
